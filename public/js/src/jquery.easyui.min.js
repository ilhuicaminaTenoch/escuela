...
},message:"Por favor, introduzca una direcci\u00f3n e-mail v\u00e1lida."},url:{validator:function(_3e9){
...
},message:"Por favor, introduzca unaa URL v\u00e1lida."},length:{validator:function(_3ea,_3eb){
var len=$.trim(_3ea).length;
return len>=_3eb[0]&&len<=_3eb[1];
},message:"Por favor, introduzca un valor entre {0} y {1}."},remote:{validator:function(_3ec,_3ed){
var data={};
data[_3ed[1]]=_3ec;
var _3ee=$.ajax({url:_3ed[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _3ee=="true";
},message:"Por favor, corrija este campo."}}};
})(jQuery);
(function($){
